 ...
 */
public class StoriesImagesPagerAdapter extends PagerAdapter {
    ...
    public StoriesImagesPagerAdapter(Context context, List<StoriesResponse.Result> filteredResult) {
        mContext = context;
