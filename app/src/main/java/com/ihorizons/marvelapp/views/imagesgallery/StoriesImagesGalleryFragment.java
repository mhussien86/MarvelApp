 ...
 */
public class StoriesImagesGalleryFragment extends BaseFragment {


    @Bind(R.id.pager)
    ViewPager imagesPager ;

    StoriesImagesPagerAdapter storiesImagesPagerAdapter;

    View mRootView ;
    private List<StoriesResponse.Result> result;

    private List<StoriesResponse.Result> filteredResult;
    ...
    public void getIntentExtras(){
        ...
        try {
            result =  (List<StoriesResponse.Result>) getActivity().getIntent().getSerializableExtra(UIConstants.CHARACTER_EXTRAS);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        storiesImagesPagerAdapter = new StoriesImagesPagerAdapter(getContext(),filteredResult );
        imagesPager.setAdapter(storiesImagesPagerAdapter);
